...
def get_parser():
    ...
    parser.add_argument("--cut_layer", type=int, default=0,
                        help="cut some layer to Distillation Train Step")
    return parser
...
def main(params):
    ...
    if params.cut_layer:
        if params.encoder_only:
            ...
            # 修改处1
            small_encoder, small_decoder = build_model(params, data['dico'], cut= True)
    ...
    if params.encoder_only:
        ...
        small_trainer = small_EncDecTrainer(small_encoder, small_decoder, data, params)
    ...
    for count in range(params.max_epoch):
        ...
        while small_trainer.n_sentences < small_trainer.epoch_size:
            ...
            for lang1, lang2 in shuf_order(params.clm_steps, params):
                small_trainer.clm_step(lang1, lang2, params.lambda_clm, big_trainer)
            # MLM steps (also includes TLM if lang2 is not None)
            for lang1, lang2 in shuf_order(params.mlm_steps, params):
                small_trainer.mlm_step(lang1, lang2, params.lambda_mlm, big_trainer)
            ...
            for lang in shuf_order(params.ae_steps):
                small_trainer.mt_step(lang, lang, params.lambda_ae, big_trainer)

            # machine translation steps
            for lang1, lang2 in shuf_order(params.mt_steps, params):
                small_trainer.mt_step(lang1, lang2, params.lambda_mt, big_trainer)
        ...
        logger.info("============ End of epoch %i ============" % small_trainer.epoch)
