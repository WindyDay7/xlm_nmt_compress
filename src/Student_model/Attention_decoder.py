...
class Attention_decoder(nn.Module):
    def __init__(self, hidden_size, output_size, dropout_p=0.1, max_length = MAX_LENGTH):
        ...
        self.lstm = nn.GRU(self.hidden_size, self.hidden_size, bidirectional=True)
    ...
    def forward(self, in_put, hidden, encoder_outputs, Batch_size):
        ...
        # 这里是修改Attention 的计算方法, 对于 Batch_size 的情况十分关键
